...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, fcm, router, localStorage, nav, storage) {
    ...
    AppComponent.prototype.initPushNotification = function () {
        ...
        this.fcm.getToken().then(function (token) {
            ...
            localStorage.setItem('device_token', _this.device_token);
            var myItemDeviceToken = localStorage.getItem('device_token');
            console.log('myItemDeviceToken  ==>  ' + myItemDeviceToken);
            _this.storage.set('device_Token', _this.device_token);
            //backend.registerToken(token);
            console.log('*************_________-------*** device_Token ---- ' + _this.storage.get('device_Token') || false);
        });
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.localStorage.ready().then(function () {
                _this.localStorage.get('url').then(function (val) {
                    // console.log(val);
                    _this.login_url = val;
                    // console.log(this.login_url);
                    if (_this.login_url === null) {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](7, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_8__["LOCAL_STORAGE"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], Object])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _global_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./global.service */ "./src/app/global.service.ts");
...
/* harmony import */ var ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-webstorage-service */ "./node_modules/ngx-webstorage-service/fesm5/ngx-webstorage-service.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
                ...
                ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_14__["StorageServiceModule"],
                _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"]],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_9__["FCM"],
                _global_service__WEBPACK_IMPORTED_MODULE_11__["GlobalService"],
...
module.exports = __webpack_require__(/*! /Users/terralogic/Documents/Rajkumar/ionic/AtCampusMaster_Oct15/ionic4-push/src/main.ts */"./src/main.ts");
